...
_.extend(ApkGenerator.prototype, {
   ...
   */
  generate: function (manifestUrl, appType, projectBuilder, manifest, miniManifest, zipFileLocation, loader, cb) {

    var self = this;

    projectBuilder.create(manifestUrl, manifest, appType, loader, onCreate);
