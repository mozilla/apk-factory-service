...
module.exports = function(manifestUrl, loader, projectBuilderDest, appBuildDir, cb) {
  ...
  loader.load(manifestFilename, function (err, string) {
    ...
    try {                
	  ...
	  console.log('miniManifest', miniManifest);
          return cb(null, manifest, miniManifest, zipFileLocation, projectBuilderDest, loader);
