...
_.extend(ApkProject.prototype, {
  ...
  cleanup: function () {
    // TODO this logs an error... never did that before...
    console.log('Removing', typeof this.dest, this.dest);
    try {
      fs.rmrfSync(this.dest);
    } catch(e) {
      console.log('AOK ouch', new Error(e));
    }
    console.log('AOK no error yet');
  }
